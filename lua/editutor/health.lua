...
function M.check()
  ...
  info("Workflow:")
  info("  1. <leader>mq  - Spawn a question block [Q:id]...[PENDING:id]")
  info("  2. Type your question inside the block")
  info("  3. <leader>ma  - Process all pending questions")
  info("")
  info("Context modes:")
  info("  - FULL_PROJECT: Sends entire project if < 25k tokens")
  info("  - ADAPTIVE: Import graph + LSP definitions for large projects")
  info("")
  info("Commands:")
  info("  :EditutorQuestion - Spawn question block")
  info("  :EditutorAsk      - Process pending questions")
  info("  :EditutorHistory  - View Q&A history")
  info("  :EditutorBrowse   - Browse by date")
  info("")
